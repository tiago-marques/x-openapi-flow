...
- [ ] Review documentation consistency:
  - [ ] `docs/wiki/getting-started/Adoption-Playbook.md`
  - [ ] `docs/wiki/reference/Troubleshooting.md`
  - [ ] `docs/wiki/engineering/Real-Examples.md`
