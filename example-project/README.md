...
- `examples/order-openapi-flow.yaml`: complete sidecar example (all extension fields)
- `examples/order-openapi-flow.json`: complete sidecar example (all extension fields)

Naming convention:

- `{context}-openapi-flow.yaml`
- `{context}-openapi-flow.json`
